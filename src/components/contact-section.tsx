  ...
  if (state.succeeded) {
    return (
      <div className="py-12 text-center">
        ...
        <p className="text-black dark:text-gray-400">Thanks for reaching out. I&apos;ll get back to you soon.</p>
      </div>
    );
  }
      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-24">
        ...
        <div className="space-y-12">
          <div>
             ...
             <p className="text-black dark:text-gray-400 leading-relaxed mb-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
               ...
               <div>
                  ...
                  <a href="mailto:reachrohith@outlook.com" className="text-black dark:text-gray-400 hover:text-blue-500 transition-colors">reachrohith@outlook.com</a>
               </div>
            </div>
            ...
            <div className="flex items-start gap-4">
               ...
               <div>
                  ...
                  <p className="text-black dark:text-gray-400">Aberdeen, UK</p>
               </div>
            </div>
            ...
            <div className="flex items-start gap-4">
               ...
               <div>
                  ...
                  <p className="text-black dark:text-gray-400">Open to new opportunities</p>
               </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-6 rounded-2xl bg-gray-50 dark:bg-white/[0.03] border border-gray-100 dark:border-white/10">
           <div className="space-y-2">
             <label htmlFor="name" className="text-sm font-medium text-black dark:text-gray-400">Name</label>
             <input
               id="name"
               type="text" 
               name="name"
           ...
           <div className="space-y-2">
             <label htmlFor="email" className="text-sm font-medium text-black dark:text-gray-400">Email</label>
             <input
               id="email"
               type="email" 
               name="email"
           ...
           <div className="space-y-2">
             <label htmlFor="message" className="text-sm font-medium text-black dark:text-gray-400">Message</label>
             <textarea
               id="message"
               name="message"
